        ...
        <ol>
            ...
            <li className={rules}>
                <ol>
                    ...
                    <li>
                        <p>1.1.2 Данные, которые автоматически передаются сайтом <Link className={link} to={ROUTES.HOME}>louange.ru</Link> в процессе его использования
            ...
            <li className={rules}>
                <p>1.2. Настоящая Политика применима только к сайту <Link className={link} to={ROUTES.HOME}>louange.ru</Link> и не контролирует, и не несет ответственность
                    за сайты третьих лиц, на которые Пользователь может перейти по ссылкам, доступным на сайте <Link className={link} to={ROUTES.HOME}>louange.ru</Link>. На таких сайтах у пользователя
            ...
            <li className={rules}>
                <p>1.3. Сайт в общем случае не проверяет достоверность персональной информации, предоставляемой пользователями,
                    и не осуществляет контроль за их дееспособностью. Однако сайт <Link className={link} to={ROUTES.HOME}>louange.ru</Link> исходит из того, что Пользователь предоставляет достоверную
