                ...
                {!formFilled &&
                    <>
                        ...
                        <form className="modal__form">
                            ...
                            <input className="modal__input" type="email" placeholder="Ваш e-mail" required />
                            <textarea className="modal__input modal__textarea" placeholder="Опишите ваш проект" required></textarea>
                            <div className="modal__row">
                                <input type="checkbox" className="modal__checkbox" id="checkbox" required />
