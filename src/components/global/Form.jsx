        ...
        <form className={styles.form}>
            <div className={styles.inner}>
                ...
                <div className={styles.row}>
                    ...
                    <p className={styles.text}>Я согласен с <Link to={`/agreement`} className={styles.link}>политикой обработки персональных данных</Link> и даю 
                    <Link to={`/agreement`} className={styles.link}> согласие</Link> на обработку своих персональных данных
                    </p>
                </div>
